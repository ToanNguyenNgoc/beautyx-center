...
import { useDebounce, useQueryParams, useSwr } from 'app/hooks'
  ...
  return (
    <>
      ...
      <XPagination
        ...
        onChangePage={(page: number) => handleQueryString('page', page)}
        totalPage={totalPage}
      />
    </>
  );
